...
public class DataWarehouseTest extends Base {
		...
		public void verifyDataWarehousePage() {
			...
			String expected = "https://www.rythmos.com/data-warehouse";
		...
		public void closeBrowser() {
			driver.close();
			driver.quit();
			System.out.println("Data Warehouse page test completed successfully!");
		}		
}
